...
var _entities_reducer = __webpack_require__(27);

var _api_util = __webpack_require__(28);

var _pokemon_actions = __webpack_require__(29);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

document.addEventListener('DOMContentLoaded', function () {
  var root = document.getElementById('root');
  window.combineReducers = _entities_reducer.combineReducers;
  window.fetchAllPokemon = _api_util.fetchAllPokemon;
  var getSuccess = function getSuccess(pokemon) {
    return console.log((0, _pokemon_actions.receiveAllPokemon)(pokemon));
  };
  (0, _api_util.fetchAllPokemon)().then(getSuccess);
